...
_You can trade this NFT on an external marketplace like <ExternalLink href="https://paras.id/collection/near-chan.shrm.near">Paras</ExternalLink>,_
_where the collection is already listed._
...
#### I have completed a task, but it's still showing up as an error

_Try to reload the page._

---

#### I reacted to the rules on Discord, but it's immediately removing the emoji

_This is working as intended._
_Carl bot will remove the reaction and will also remove the new-member role._

---

#### I retweeted, but it's not working

_You have to *quote retweet*._
